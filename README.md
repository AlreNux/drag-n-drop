...
# <img src='https://i.ibb.co/vLj67jt/test-task.jpg' alt='Task image' />
...
Элементы перемещаются по принципу drag and drop. Перетаскивая элемент из сайдбара в рабочую область, должен создаваться элемент в рабочий области. Количество создаваемых элементов не ограничено.
